...
// Claims pod ------------------------------------------------------------
export const makeScout = (model: ModelClient, hub?: PodHub, reportToHandle = '@claims-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'scout', reviewerName: 'Scout', model, reportToHandle, hub, eventType: 'workitem',
...
export const makeClaimEvidence = (model: ModelClient, hub?: PodHub, reportToHandle = '@claims-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'claim-evidence', reviewerName: 'Claim & Evidence', model, reportToHandle, hub,
...
export const makePrecedent = (model: ModelClient, hub?: PodHub, reportToHandle = '@claims-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'precedent', reviewerName: 'Precedent Librarian', model, reportToHandle, hub,
    jsonSchema: FINDINGS_JSON_SCHEMA,
...
export const makeDisclosure = (model: ModelClient, hub?: PodHub, reportToHandle = '@claims-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'disclosure', reviewerName: 'Disclosure Drafter', model, reportToHandle, hub,
    jsonSchema: FINDINGS_JSON_SCHEMA,
...
// Brand pod -------------------------------------------------------------
export const makeBrandVoice = (model: ModelClient, hub?: PodHub, reportToHandle = '@brand-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'brand-voice', reviewerName: 'Brand Voice', model, reportToHandle, hub,
    jsonSchema: FINDINGS_JSON_SCHEMA,
...
export const makeChannel = (model: ModelClient, hub?: PodHub, reportToHandle = '@brand-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'channel', reviewerName: 'Channel Fit', model, reportToHandle, hub,
    jsonSchema: FINDINGS_JSON_SCHEMA,
...
export const makeVisual = (model: ModelClient, hub?: PodHub, reportToHandle = '@brand-lead'): AgentHandler =>
  makeKnowledgeSource({
    role: 'visual', reviewerName: 'Visual / Image', model, reportToHandle, hub,
    jsonSchema: FINDINGS_JSON_SCHEMA,
