...
const FULL: Step[] = [
  ...
  },
  {
    ...
    desc: 'US, EU and LATAM regulators plus Brand and Claims each judge against their own rulebook, all at once.',
    tone: 'agent',
    icon: ICON.agents,
  },
  {
    n: '04',
    title: 'Debate & reconcile',
    desc: 'Competing objectives collide. Reviewers surface the conflict and negotiate a tradeoff, not a checklist.',
    tone: 'conflict',
    icon: ICON.debate,
  },
  {
    n: '05',
    title: 'Remediate or escalate',
    desc: 'Fixable gaps are auto-rewritten and re-reviewed; a genuine deadlock goes to a human for the call.',
    tone: 'human',
    icon: ICON.loop,
  },
  {
