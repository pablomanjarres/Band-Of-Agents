...
// Campaign-first app shell (dark redesign): a sidebar + glass topbar wrap the
// routed content. The home route lands on Campaigns; the single-asset Compose flow
// is gone. The artifact viewer route is kept for agent-produced artifacts.
